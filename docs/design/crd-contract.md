...
|---|---|---|
| `CacheBackend.status` | `matchedEnginePods`, `conditions`, `firstKVEventObservedAt`, `firstAvailableAt`, `observedServerInstance`, `endpoint`, `failOpen` | CacheBackend reconciler |
