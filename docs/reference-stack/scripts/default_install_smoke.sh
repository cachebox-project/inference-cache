...
log "PASS — install bundle came up, CacheIndex poller is writing, gRPC fail-open works, /snapshot rejects unauth, CacheBackend ↔ engine-pod binding signals wire up + drift cadence converges"
