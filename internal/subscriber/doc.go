...
// Package subscriber implements KV-event ingestion for the kvevent-subscriber
// sidecar. It runs next to a vLLM engine replica, subscribes to the engine's
// KV cache events over ZMQ, decodes
...
// private to the kvevent-subscriber binary (cmd/kvevent-subscriber).
package subscriber
