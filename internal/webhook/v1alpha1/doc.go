...
// from reaching the reconciler: it stamps the Phase-1 defaults (failOpen,
// lookup timeout, minimum prefix tokens, replicas) and rejects configurations
// that can't be reconciled at all (External backend without an Endpoint,
