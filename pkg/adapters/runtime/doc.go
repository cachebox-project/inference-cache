...
// internal/adapters/builtin/runtime; this package remains the supported seam
// for out-of-tree adapters. The [Registry] selects an adapter via each
// adapter's Supports method.
package runtime
